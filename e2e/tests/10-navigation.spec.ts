 ...
 * de menu. Le tableau de bord titre « Votre journée, en maîtrise. » — la
 * salutation est passée en sous-titre. Le menu
 ...
 */
const SIDEBAR_LINKS = [
  { href: "/dashboard", name: "Tableau de bord", titre: /^Votre journée/ },
